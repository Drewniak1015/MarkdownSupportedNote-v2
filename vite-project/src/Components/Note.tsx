...
const Note: React.FC<NoteListProps> = ({
  ...
  const note = NotesList.find((note) => note.id === id); // Znajdź notatkę na podstawie ID
      ...
      <div className="flex justify-between flex-col mb-6 gap-6">
        ...
        <div className="flex items-center flex-wrap">
          ...
          <button
            ...
            onClick={() => {
              const NewList = NotesList.filter((opt) => opt.id !== note.id);
